...
class N9Servicer(n9_pb2_grpc.N9Servicer):
    ...
    def ListDevices(self, req, context):
        ...
        devices_info = []
        for di in unpacked:
            devices_info.append(n9_pb2.SerialDeviceInfo(
                index=EmptyStringIfNone(di.index),
                serial=di.serial,
                port=EmptyStringIfNone(di.port),
                description=EmptyStringIfNone(di.description)))
        resp = n9_pb2.ListDevicesResp(devices_info=devices_info)
        trace_msg = n9_pb2.ListDevicesTraceMsg(resp=resp)
        self.log_trace_msg(trace_msg)
        return resp

    def ListDevicePorts(self, req, context):
        resp = n9_pb2.ListDevicePortsResp(
            ports=DirectSerial.list_device_ports())
        trace_msg = n9_pb2.ListDevicePortsTraceMsg(resp=resp)
        self.log_trace_msg(trace_msg)
        return resp

    def ListDeviceSerials(self, req, context):
        serial_numbers = DirectSerial.list_device_serials()
        resp = n9_pb2.ListDeviceSerialsResp(
            serial_numbers= DirectSerial.list_device_serials())
        trace_msg = n9_pb2.ListDeviceSerialsTraceMsg(resp=resp)
        self.log_trace_msg(trace_msg)
        return resp
    ...
    def SetBitMode(self, req, context):
        ...
        trace_msg = n9_pb2.SetBitModeTraceMsg(req=req)
        self.log_trace_msg(trace_msg)
        return n9_pb2.EmptyMsg()
...
#    n9_pb2_grpc.add_N9Servicer_to_server(N9Servicer(), server)
