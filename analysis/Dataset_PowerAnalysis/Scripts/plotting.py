...
fig, ax= plt.subplots()
ax.plot(ts0, C0, label='L0-L1')
ax.legend()
plt.xlabel('Time(ms)')
plt.ylabel('Current(ma)')
plt.savefig("l0l1.pdf")

fig, ax= plt.subplots()
ax.plot(ts1, C1, label='L1-L2')
ax.legend()
plt.xlabel('Time(ms)')
plt.ylabel('Current(ma)')
plt.savefig("l1l2.pdf")

fig, ax= plt.subplots()
ax.plot(ts2, C2, label='L2-L3')
ax.legend()
plt.xlabel('Time(ms)')
plt.ylabel('Current(ma)')
plt.savefig("l2l3.pdf")

fig, ax= plt.subplots()
ax.plot(ts3, C3, label='L3-L4')
ax.legend()
plt.xlabel('Time(ms)')
plt.ylabel('Current(ma)')
plt.savefig("l3l4.pdf")

fig, ax= plt.subplots()
ax.plot(ts4, C4, label='L4-L5')
ax.legend()
plt.xlabel('Time(ms)')
plt.ylabel('Current(ma)')
plt.savefig("l4l5.pdf")
