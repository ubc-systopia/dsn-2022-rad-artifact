...
def compute_transition_prob():
    ...
    li2 = []
    file_index1 = []
    t_regex = "Order2_MC_5CV_transition_"
    ...
    for train_index, test_index in kf.split(file_index2):
        ...
        for item in test:
            ...
            for i in range(1, len(test_procedure_list) - 1):
                ...
                subset = df_transition.loc[(df_transition['prev_state_clean'] == prev_cmd.strip()) &
...
def main():
    ...
    plt.tight_layout()
    plt.savefig("./perplexity_score_2O_MC_5FCV.pdf")
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("./perplexity_score_boxplot_2O_MC_5FCV.pdf")
    plt.show()
    ...
    #plt.ylim(0,6)
    plt.tight_layout()
    plt.savefig("./perplexity_score_boxplot_nohue_2O_MC_5FCV.pdf")
    plt.show()
...
F1 : 0.6
Accuracy : 0.84
Weighted Accuracy : 0.8571428571428571 0.864406779661017
True Negative Rate : 0.8181818181818182
**********************************************
"""
